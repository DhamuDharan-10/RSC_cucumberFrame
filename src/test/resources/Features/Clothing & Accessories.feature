...
Feature: Validating the Clothing & Accessories
...
@smoke
Scenario: Validating the Clothing & Accessories Products
...
@smoke
Scenario: Validating the HomeWare Products 
...
@smoke
Scenario Outline: Validating the User
